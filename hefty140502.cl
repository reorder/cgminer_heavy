...
inline uint sha256_112_last(const uint *data)
{
    uint temp1;
    uint W0 = data[0];
    uint W1 = data[1];
...
inline uint blake512_112_last(const uint *msg)
{
...
inline uint groestl512_112_last(const uint *msg, __local ulong *tables)
{
#ifdef BROKEN_LOCAL
    ...
    Z0 = T0 = as_ulong((uint2)(SWAP32(msg[0]), SWAP32(msg[1])));
    Z1 = T1 = as_ulong((uint2)(SWAP32(msg[2]), SWAP32(msg[3])));
    Z2 = T2 = as_ulong((uint2)(SWAP32(msg[4]), SWAP32(msg[5])));
    Z3 = T3 = as_ulong((uint2)(SWAP32(msg[6]), SWAP32(msg[7])));
    Z4 = T4 = as_ulong((uint2)(SWAP32(msg[8]), SWAP32(msg[9])));
    Z5 = T5 = as_ulong((uint2)(SWAP32(msg[10]), SWAP32(msg[11])));
    Z6 = T6 = as_ulong((uint2)(SWAP32(msg[12]), SWAP32(msg[13])));
    Z7 = T7 = as_ulong((uint2)(SWAP32(msg[14]), SWAP32(msg[15])));
    Z8 = T8 = as_ulong((uint2)(SWAP32(msg[16]), SWAP32(msg[17])));
    Z9 = T9 = as_ulong((uint2)(SWAP32(msg[18]), SWAP32(msg[19])));
    ZA = TA = as_ulong((uint2)(SWAP32(msg[20]), SWAP32(msg[21])));
...
inline uint keccak512_112_last(uint * restrict msg)
{
...
inline void hefty80(uint* restrict hashx, uint sponge[4], __global const uint *restrict h)
{
    uint W[16];
    W[0] = hashx[16];
    W[1] = hashx[17];
